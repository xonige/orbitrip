            ...
            <div style="font-family: Arial, sans-serif; padding: 20px; background-color: #f9fafb;">
                <div style="max-width: 500px; margin: 0 auto; background-color: white; border: 1px solid #e5e7eb; border-radius: 10px; overflow: hidden;">
                    <div style="background-color: #10b981; padding: 20px; text-align: center; color: white;">
                        <h2 style="margin: 0;">New Booking! / Новое бронирование!</h2>
                        <p style="margin: 5px 0 0 0;">#${bookingIdShort}</p>
                    </div>
                    <div style="padding: 20px;">
                        <p style="font-weight: bold; margin-bottom: 5px; color: #6b7280;">ROUTE / МАРШРУТ:</p>
                        <p style="margin-top: 0; font-size: 16px;">${booking.tourTitle}</p>
                        
                        <p style="font-weight: bold; margin-bottom: 5px; color: #6b7280; margin-top: 15px;">DATE / ДАТА:</p>
                        <p style="margin-top: 0; font-size: 16px;">${booking.date}</p>
                        
                        <p style="font-weight: bold; margin-bottom: 5px; color: #6b7280; margin-top: 15px;">CLIENT / КЛИЕНТ:</p>
                        ...
                        <div style="margin-top: 25px; background-color: #ecfdf5; padding: 15px; border-radius: 8px; text-align: center;">
                            <span style="display: block; font-size: 12px; color: #065f46; font-weight: bold;">PRICE (CASH) / ЦЕНА (НАЛИЧНЫЕ):</span>
                        ...
                        <p style="text-align: center; margin-top: 20px; font-size: 12px; color: #9ca3af;">
                            ...
                            Пожалуйста, подтвердите заказ в личном кабинете.
                        </p>
                    </div>
                </div>
            </div>
